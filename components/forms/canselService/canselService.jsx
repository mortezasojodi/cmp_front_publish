             ...
             <div className={styles.inform}>
                ...
                <div className={styles.cancelForm}>
                  {options.map((option, index) => (
                    <label className={`${styles.radioButtonLabel} ${selectedOption === option && styles.selectedOption}`} key={index}>
                      <input
                        type="radio"
                        name="option"
                        value={option}
              ...
              <div className={styles.submitButtons}>
                  ...
                  <button className={styles.canselService} type="button" onClick={handleNextStep}> Cancel Service <AiOutlineStop size={22} /></button>
                </div>
            </>
          ) : (
            <>
              <div className={styles.inform}>
                <svg width="112" height="112" viewBox="0 0 112 112" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="56" cy="56" r="56" fill="#D57300" fill-opacity="0.1"/>
              ...
              <button className={styles.home} onClick={goHome}>Home <GoHome size={24}/></button>
            </>
          )}
        </div>
      </div>

    ...
    <>
      ...
      <div className={styles.formSection}>
        ...
        <div className={`${styles.formSection} ${styles.labelTwoButtom}`}>
                  <label htmlFor='pickupLocation' className={styles.label}>Pickup point:</label>
        ...
        <div className={styles.submitButtons}>
          ...
          <button type="submit" >sign up <IoLogInOutline size={24} /></button>
        </div>
        
      </form>
      
      {/* <SignUpButtons nameOfButton={"sing up"} iconOfButton={<IoLogInOutline size={24} />}/> */}
    </>
  );
};
